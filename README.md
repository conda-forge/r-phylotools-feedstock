...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-phylotools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10641&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-phylotools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-phylotools` can be installed with:

```
conda install r-phylotools
```

It is possible to list all of the versions of `r-phylotools` available on your platform with:
